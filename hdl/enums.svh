...
typedef enum bit [5:0] {
    ...
    OP_BR_REL        = 6'b001100,
    OP_BR_ABS        = 6'b001101,
    OP_CALL_REL      = 6'b001110,
    OP_CALL_ABS      = 6'b001111,
    OP_RET           = 6'b010000,
    OP_RET_POP_VALUE = 6'b010001,
    OP_STM           = 6'b010010,
    OP_LDM           = 6'b010011,
    OP_MOVBK         = 6'b010100,
    OP_CMPBK         = 6'b010101,
    ...
    OP_INM           = 6'b010111,
    OP_OUTM          = 6'b011000,
    OP_NOT1_CY       = 6'b011001,
    OP_CLR1_CY       = 6'b011010,
    OP_SET1_CY       = 6'b011011,
    OP_DI            = 6'b011100,
    OP_EI            = 6'b011101,
    OP_CLR1_DIR      = 6'b011110,
    OP_SET1_DIR      = 6'b011111,
    OP_HALT          = 6'b100000,
    OP_SHIFT         = 6'b100001,
    OP_SHIFT_1       = 6'b100010,
    OP_SHIFT_CL      = 6'b100011,
    OP_LDEA          = 6'b100100,
    OP_CVTDB         = 6'b100101,
    OP_CVTBD         = 6'b100110,
    OP_CVTBW         = 6'b100111,
...
typedef enum bit [5:0] {
    INITIAL                = 6'b000000,
    TERMINAL               = 6'b000001,
    PREFIX_CONTINUE        = 6'b000010,
    ILLEGAL                = 6'b000011,
    ROOT_00xxx00x          = 6'b000100,
    ROOT_00xxx01x          = 6'b000101,
    ROOT_1000000x          = 6'b000110,
    ROOT_1000001x          = 6'b000111,
    ROOT_1101000x          = 6'b001000,
    ROOT_1101001x          = 6'b001001,
    ROOT_1100000x          = 6'b001010,
    ROOT_0011100x          = 6'b001011,
    ROOT_0011101x          = 6'b001100,
    ROOT_11111111          = 6'b001101,
    ROOT_11111110          = 6'b001110,
    ROOT_1000010x          = 6'b001111,
    ROOT_11110110          = 6'b010000,
    ROOT_11110111          = 6'b010001,
    ROOT_01101011          = 6'b010010,
    ROOT_01101001          = 6'b010011,
    ROOT_10001101          = 6'b010100,
    ROOT_1000100x          = 6'b010101,
    ROOT_1000101x          = 6'b010110,
    ROOT_1100011x          = 6'b010111,
    ROOT_10001110          = 6'b011000,
    ROOT_10001100          = 6'b011001,
    ROOT_11000101          = 6'b011010,
    ROOT_11000100          = 6'b011011,
    ROOT_1000011x          = 6'b011100,
    ROOT_10001111          = 6'b011101,
    ROOT_01100010          = 6'b011110,
    ROOT_00001111_0001000x = 6'b011111,
    ROOT_00001111_0001100x = 6'b100000,
    ROOT_00001111_0001001x = 6'b100001,
    ROOT_00001111_0001101x = 6'b100010,
    ROOT_00001111_0001010x = 6'b100011,
    ROOT_00001111_0001110x = 6'b100100,
    ROOT_00001111_0001011x = 6'b100101,
    ROOT_00001111_0001111x = 6'b100110,
    ROOT_00001111_00101010 = 6'b100111,
    ROOT_00001111_00101000 = 6'b101000,
    ROOT_00001111          = 6'b101001
