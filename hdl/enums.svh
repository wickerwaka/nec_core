...
typedef enum bit [5:0] {
    ...
    DELAY_3                = 6'b000101,
    DELAY_4                = 6'b000110,
    PREFIX_CONTINUE        = 6'b000111,
    ILLEGAL                = 6'b001000,
    ROOT_00xxx00x          = 6'b001001,
    ROOT_00xxx01x          = 6'b001010,
    ROOT_1000000x          = 6'b001011,
    ROOT_1000001x          = 6'b001100,
    ROOT_1101000x          = 6'b001101,
    ROOT_1101001x          = 6'b001110,
    ROOT_1100000x          = 6'b001111,
    ROOT_0011100x          = 6'b010000,
    ROOT_0011101x          = 6'b010001,
    ROOT_11111111          = 6'b010010,
    ROOT_11111110          = 6'b010011,
    ROOT_1000010x          = 6'b010100,
    ROOT_11110110          = 6'b010101,
    ROOT_11110111          = 6'b010110,
    ROOT_01101011          = 6'b010111,
    ROOT_01101001          = 6'b011000,
    ROOT_10001101          = 6'b011001,
    ROOT_1000100x          = 6'b011010,
    ROOT_1000101x          = 6'b011011,
    ROOT_1100011x          = 6'b011100,
    ROOT_10001110          = 6'b011101,
    ROOT_10001100          = 6'b011110,
    ROOT_11000101          = 6'b011111,
    ROOT_11000100          = 6'b100000,
    ROOT_1000011x          = 6'b100001,
    ROOT_10001111          = 6'b100010,
    ROOT_01100010          = 6'b100011,
    ROOT_00001111_0001000x = 6'b100100,
    ROOT_00001111_0001100x = 6'b100101,
    ROOT_00001111_0001001x = 6'b100110,
    ROOT_00001111_0001101x = 6'b100111,
    ROOT_00001111_0001010x = 6'b101000,
    ROOT_00001111_0001110x = 6'b101001,
    ROOT_00001111_0001011x = 6'b101010,
    ROOT_00001111_0001111x = 6'b101011,
    ROOT_00001111_00101010 = 6'b101100,
    ROOT_00001111_00101000 = 6'b101101,
    ROOT_00001111_00110011 = 6'b101110,
    ROOT_00001111_00110001 = 6'b101111,
    ROOT_00001111_00111001 = 6'b110000,
    ROOT_00001111          = 6'b110001
