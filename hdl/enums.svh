...
typedef enum bit [5:0] {
    ...
    OP_CALL_NEAR      = 6'b001111,
    OP_CALL_FAR       = 6'b010000,
    OP_POP_VALUE      = 6'b010001,
    OP_SEG_PREFIX     = 6'b010010,
    OP_REP_PREFIX     = 6'b010011,
    OP_BUSLOCK_PREFIX = 6'b010100,
    OP_STM            = 6'b010101,
    OP_LDM            = 6'b010110,
    OP_MOVBK          = 6'b010111,
    OP_CMPBK          = 6'b011000,
    ...
    OP_INM            = 6'b011010,
    OP_OUTM           = 6'b011011,
    OP_NOT1_CY        = 6'b011100,
    OP_CLR1_CY        = 6'b011101,
    OP_SET1_CY        = 6'b011110,
    OP_DI             = 6'b011111,
    OP_EI             = 6'b100000,
    OP_CLR1_DIR       = 6'b100001,
    OP_SET1_DIR       = 6'b100010,
    OP_HALT           = 6'b100011,
    OP_SHIFT          = 6'b100100,
    OP_SHIFT_1        = 6'b100101,
    OP_SHIFT_CL       = 6'b100110,
    OP_LDEA           = 6'b100111,
    OP_CVTDB          = 6'b101000,
    OP_CVTBD          = 6'b101001,
    OP_CVTBW          = 6'b101010,
    ...
    OP_DIV            = 6'b101100,
    OP_DIVU           = 6'b101101,
    OP_PREPARE        = 6'b101110,
    OP_DISPOSE        = 6'b101111,
    OP_CHKIND         = 6'b110000,
    OP_TRANS          = 6'b110001,
    OP_BRK3           = 6'b110010,
    OP_BRK            = 6'b110011,
